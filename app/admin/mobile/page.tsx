              ...
              {settingsLoading ? (
                ...
                <>
                  ...
                  <a
                    ...
                    className="block bg-violet-600 hover:bg-violet-700 active:bg-violet-800 rounded-2xl shadow-sm p-5 transition-colors no-underline"
                  >
                    <div className="flex items-center gap-4">
                      <div className="text-4xl">💰</div>
                      <div>
                        <div className="font-bold text-white text-base">Income Manager</div>
                        <div className="text-violet-200 text-xs mt-0.5">Upload daily report &amp; cash count photos → auto-fill numbers</div>
                      </div>
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-5 h-5 text-violet-300 ml-auto shrink-0"><path d="M9 18l6-6-6-6"/></svg>
                    </div>
                  </a>
