        ...
        {step === 'service' && (
          <div className="p-6">
            ...
            <div className="mt-6 rounded-2xl border border-sky-100 bg-sky-50 overflow-hidden">
              <div className="px-4 py-3 bg-sky-100 text-sky-900 font-semibold text-sm">💰 Pricing Reference</div>
              <div className="p-4 space-y-5 text-xs text-gray-700">

                {/* Bath & Brush */}
                <div>
                  <p className="font-bold text-sky-800 mb-2">🛁 Bath &amp; Brush</p>
                  <table className="w-full text-center border-collapse">
                    <thead>
                      <tr className="text-gray-500">
                        <th className="text-left pb-1 font-medium">Size</th>
                        <th className="pb-1 font-medium">Smooth</th>
                        <th className="pb-1 font-medium">Long</th>
                        <th className="pb-1 font-medium">Poodle/Doodle</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-sky-100">
                      <tr><td className="text-left py-1">Up to 15 lbs</td><td>$50</td><td>$60</td><td>$70</td></tr>
                      <tr><td className="text-left py-1">16–30 lbs</td><td>$60</td><td>$75</td><td>$85</td></tr>
                      <tr><td className="text-left py-1">31–50 lbs</td><td>$70</td><td>$85</td><td>$100</td></tr>
                      <tr><td className="text-left py-1">50–70 lbs</td><td>$80</td><td>$95</td><td>$120</td></tr>
                    </tbody>
                  </table>
                </div>
                ...
                {/* Bath & Haircut */}
                <div>
                  <p className="font-bold text-sky-800 mb-2">✂️ Bath &amp; Haircut</p>
                  <table className="w-full text-center border-collapse">
                    <thead>
                      <tr className="text-gray-500">
                        <th className="text-left pb-1 font-medium">Size</th>
                        <th className="pb-1 font-medium">Simply Cute</th>
                        <th className="pb-1 font-medium">Asian Fusion</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-sky-100">
                      <tr><td className="text-left py-1">Up to 15 lbs</td><td>$70</td><td>$110</td></tr>
                      <tr><td className="text-left py-1">16–30 lbs</td><td>$90</td><td>$130</td></tr>
                      <tr><td className="text-left py-1">31–50 lbs</td><td>$100</td><td>$190</td></tr>
                      <tr><td className="text-left py-1">51–70 lbs</td><td>$120</td><td>$240</td></tr>
                    </tbody>
                  </table>
                  <p className="text-gray-400 mt-1 italic">* Over 70 lbs — please inquire with us.</p>
                </div>

                {/* Doodle Bath & Haircut */}
                <div>
                  <p className="font-bold text-sky-800 mb-2">🐩 Doodle Bath &amp; Haircut</p>
                  <table className="w-full text-center border-collapse">
                    <thead>
                      <tr className="text-gray-500">
                        <th className="text-left pb-1 font-medium">Size</th>
                    ...
                    <tbody className="divide-y divide-sky-100">
                      <tr><td className="text-left py-1">Up to 15 lbs</td><td>$100</td><td>$130</td></tr>
                      <tr><td className="text-left py-1">16–30 lbs</td><td>$120</td><td>$170</td></tr>
                      <tr><td className="text-left py-1">31–50 lbs</td><td>$140</td><td>$240</td></tr>
                      <tr><td className="text-left py-1">51–70 lbs</td><td>$170</td><td>$290</td></tr>
                    </tbody>
                  </table>
                </div>
                ...
                {/* Add-ons */}
                <div>
                  <p className="font-bold text-sky-800 mb-2">➕ Add-ons (added to package)</p>
                  <ul className="space-y-0.5 text-gray-600">
                    <li>Partial Trim — <span className="font-medium">+$10–$30</span></li>
                    <li>Flea &amp; Tick Shampoo — <span className="font-medium">+$15/$25</span></li>
                    <li>De-matting / Extra Brushing — <span className="font-medium">+$20/$40/$60</span></li>
                    <li>De-shedding Service — <span className="font-medium">+$15/$20/$30</span></li>
                    <li>Hand-stripping — <span className="font-medium">+$20/$40</span></li>
                    <li>Extra Handling Fee — <span className="font-medium">+$20</span></li>
                    <li>Hair Dye — <span className="font-medium">from $30</span> ($15–$25/area · full body $150+)</li>
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mb-1">No bath / no haircut</p>
                    <p>Nail · Gland · Teeth · Ear — <span className="font-medium">$30</span></p>
                  </div>
                  <div>
                    <p className="font-bold text-sky-800 mb-1">À La Carte</p>
                    <p className="text-gray-500 text-xs mb-1">No grooming needed</p>
                    <ul className="space-y-0.5">
                      <li>Nail trimming — <span className="font-medium">$15</span></li>
                      <li>Gland Expression — <span className="font-medium">$15</span></li>
                      <li>Pads Trim — <span className="font-medium">$10</span></li>
                      <li>Teeth Brush — <span className="font-medium">$10</span></li>
                      <li>Ear Cleaning — <span className="font-medium">$10</span></li>
                    </ul>
                  </div>
                </div>
